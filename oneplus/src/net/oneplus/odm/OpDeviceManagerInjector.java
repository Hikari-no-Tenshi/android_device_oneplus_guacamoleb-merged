...
public class OpDeviceManagerInjector {
    ...
    public void preserveStopActivity(Context context, String packageName, long activityLaunchTime, long activityFinishTime) {
        makeSureInstanceInitialized();
        sOpDeviceManager.preserveStopActivity(context, packageName, activityLaunchTime, activityFinishTime);
    }
